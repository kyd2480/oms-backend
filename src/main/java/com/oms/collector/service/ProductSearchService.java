...
public class ProductSearchService {
    ...
    private int score(Product product, String rawKeyword, String normalizedKeyword, List<String> tokens) {
        ...
        String barcode2 = safe(product.getBarcode2());
        ...
        String barcode2Norm = normalize(barcode2);
        ...
        if (sku.equalsIgnoreCase(rawKeyword) || barcode.equalsIgnoreCase(rawKeyword) || barcode2.equalsIgnoreCase(rawKeyword)) score += 1000;
        if (optionCode.equalsIgnoreCase(rawKeyword)) score += 980;
        if (skuNorm.equals(normalizedKeyword) || barcodeNorm.equals(normalizedKeyword) || barcode2Norm.equals(normalizedKeyword) || optionCodeNorm.equals(normalizedKeyword)) score += 950;
        ...
        if (!barcode2Norm.isBlank() && barcode2Norm.startsWith(normalizedKeyword)) score += 650;
        ...
        if (!colorNorm.isBlank() && colorNorm.startsWith(normalizedKeyword)) score += 540;
        ...
        if (!barcode2Norm.isBlank() && barcode2Norm.contains(normalizedKeyword)) score += 450;
        ...
        if (!colorNorm.isBlank() && colorNorm.contains(normalizedKeyword)) score += 320;
        ...
        for (String token : tokens) {
            ...
            if (!barcode2Norm.isBlank() && barcode2Norm.contains(token)) score += 110;
            ...
            if (!colorNorm.isBlank() && colorNorm.contains(token)) score += 80;
